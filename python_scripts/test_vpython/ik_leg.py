...
class Leg:
    def __init__(self, b_1_settings=None, cmd_queue=None, group_index=1):
        ...
        self.b_4_box_1=box(frame=self.b_4,
                            size=(20, 43.5, 2),
                            pos=(6.14, 10.2, 25.5),
                            axis=rotate((1,0,0), angle=-31.29/180.*pi, axis=(0,0,1)),
                            color=(0, 1, 0))
        ...
        self.b_4_box_3=box(frame=self.b_4,
                            size=(25, 92.48, 25),
                            pos=(7.44, 64.86, 0.0),
                            axis=rotate((1,0,0), angle=18.39/180.*pi, axis=(0,0,1)),
                            color=(0, 1, 0))
    ...
    def set_angle_0(self, in_angle):
        ...
        if sub_angle != 0.0:
            ...
            if self.cmd_queue is not None:
                self.cmd_queue.put((self.group_index, 3, (pi - (in_angle + border)) / pi))
    ...
    def get_end_pos_angles(self, end_pos, angle1):
        ...
        b = math.sqrt( math.pow((end_pos[0] - end1[0]), 2) + math.pow((end_pos[1] - end1[1]), 2) )
        ...
        if self.can_move:
            ...
            if self.first_step:
                ...
                if self.move_angle == 0:
                    ...
                    for id in [0,1,2,3]:
                        leg = self.legs[id]
                        new_pos_1 = self.f_1.pos + rotate(vector=(leg.end_pos - self.f_1.pos), angle=self.move_angle / 2, axis=self.f_1.up)
                        new_pos_2 = self.f_1.pos + rotate(vector=(leg.end_pos - self.f_1.pos), angle=self.move_angle, axis=self.f_1.up)
                        leg.anim = [(0.0 + dt, vector(leg.end_pos)),
